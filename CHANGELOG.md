...
## Updates
- Updating `ad_reporting_metrics.yml` to be up to date with [dbt Metrics 1.4](https://docs.getdbt.com/docs/build/metrics#derived-metrics) ([PR #82](https://github.com/fivetran/dbt_ad_reporting/pull/82))
