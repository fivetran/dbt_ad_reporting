...
| [`ad_reporting__ad_report`](https://fivetran.github.io/dbt_ad_reporting/#!/model/model.ad_reporting.ad_reporting__ad_report) | Represents daily performance at the individual ad level across all advertising platforms, including `spend`, `clicks`, `impressions`, and `conversions`.<br><br>**Example Analytics Questions:**<ul><li>Which creative formats perform best across different advertising platforms?</li><li>How do similar ad creatives perform on different platforms?</li><li>What creative elements drive success across multiple platforms?</li></ul> |
| [`ad_reporting__keyword_report`](https://fivetran.github.io/dbt_ad_reporting/#!/model/model.ad_reporting.ad_reporting__keyword_report) | Represents daily performance at the individual keyword level across search advertising platforms, including `spend`, `clicks`, `impressions`, and `conversions`.<br><br>**Example Analytics Questions:**<ul><li>Which keywords drive the best performance across Google, Microsoft, and other search platforms?</li><li>How do keyword match types perform differently across platforms?</li><li>Are there keyword expansion opportunities across platforms?</li></ul> |
| [`ad_reporting__search_report`](https://fivetran.github.io/dbt_ad_reporting/#!/model/model.ad_reporting.ad_reporting__search_report) | Represents daily performance at the individual search query level across search advertising platforms, including `spend`, `clicks`, `impressions`, and `conversions`.<br><br>**Example Analytics Questions:**<ul><li>What search queries convert best across different search platforms?</li><li>Which search terms should be added as keywords across multiple platforms?</li><li>How do search query patterns differ between platforms?</li></ul> |
| [`ad_reporting__url_report`](https://fivetran.github.io/dbt_ad_reporting/#!/model/model.ad_reporting.ad_reporting__url_report) | Represents daily performance at the individual URL level across all advertising platforms, including `spend`, `clicks`, `impressions`, and `conversions`, with UTM parameter tracking.<br><br>**Example Analytics Questions:**<ul><li>Which landing pages perform best across different advertising platforms?</li><li>How do UTM campaign parameters correlate with performance across platforms?</li><li>Which URLs should be promoted more heavily across multiple platforms?</li></ul> |
...
<p align="center">
  <a href="https://fivetran-ad-reporting.streamlit.app/ad_performance">
    <img src="https://raw.githubusercontent.com/fivetran/dbt_ad_reporting/main/images/streamlit_example.png" alt="Fivetran Ad Reporting Streamlit App" width="100%">
  </a>
</p>
