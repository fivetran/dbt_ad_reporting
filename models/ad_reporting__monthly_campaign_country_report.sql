...
{# Log final filtered enabled_packages (after applying global enable flags) #}
{{ log("\n Country report - enabled_packages after macro filtering: " ~ enabled_packages, info=True) }}
